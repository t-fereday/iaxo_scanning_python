...
# Default calibration directory: <repo>/calibration/, anchored to this package
# so it does not depend on the cwd.  (Replaces IDL's hardcoded Windows path.)
CALIB_DIR = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'calibration')


def calibration_file_match(filedate, dir_calib=None):
    """
